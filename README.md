...
| `obtenerUltimoIdPersona()` | Obtiene el último `id_persona` insertado en la tabla `persona`. Utiliza la conexión de la clase `Conexion` y muestra un mensaje de error si la consulta falla. |
