...
import Controlador.SeleccionTabla;
...
public class Admin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtAMA.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtAMAKeyTyped(evt);
            }
        });
                ...
                .addGroup(AAdministradoresLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(AAdministradoresLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, AAdministradoresLayout.createSequentialGroup()
                            ...
                            .addGap(50, 50, 50)
                            .addComponent(btnEditarA1, javax.swing.GroupLayout.PREFERRED_SIZE, 166, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(229, 229, 229))))
                .addGap(24, 24, 24))
        );
        ...
        txtAME.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtAMEKeyTyped(evt);
            }
        });
            ...
            .addGroup(AsalariadosLayout.createSequentialGroup()
                ...
                .addGroup(AsalariadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(AsalariadosLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(btnEnviar_EM, javax.swing.GroupLayout.PREFERRED_SIZE, 172, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(AsalariadosLayout.createSequentialGroup()
    ...
    private void btnEditarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEditarMouseClicked
        ...
        if (!correo.matches("^[\\w.-]+@(gmail\\.com|hotmail\\.com|yahoo\\.com|outlook\\.com|itoaxaca\\.edu\\.mx)$")) {
        JOptionPane.showMessageDialog(this, "Por favor, ingrese un correo electrónico válido con un dominio permitido (gmail.com, hotmail.com, yahoo.com, outlook.com,itoaxaca.edu.mx).", "Correo inválido", JOptionPane.ERROR_MESSAGE);
        return;
        }
        
         // Validar que la edad sea un número válido y esté en el rango de 18 a 99
        int edad;
        try {
            edad = Integer.parseInt(edadStr);
            if (edad < 18 || edad > 99) {
                JOptionPane.showMessageDialog(this, "Por favor, ingrese una edad válida (mayor a 18 y menor a 100).", "Edad inválida", JOptionPane.ERROR_MESSAGE);
                return;
            }
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "Por favor, ingrese un número válido para la edad.", "Edad inválida", JOptionPane.ERROR_MESSAGE);
            return;
        }
 ...
 //----------------------------------------------------------------------------------------------------Selecciona los datos del registro
          try {
            ...
            Controlador.Metodos objetoRegistro = new Controlador.Metodos();
    ...
    private void AltaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AltaActionPerformed
        ...
        Controlador.Metodos m = new Controlador.Metodos();
    ...
    private void txtAMAKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtAMAKeyTyped
        // TODO add your handling code here:
        char c = evt.getKeyChar();
    ...
    private void txtAMEKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtAMEKeyTyped
        // TODO add your handling code here:
        char c = evt.getKeyChar();
