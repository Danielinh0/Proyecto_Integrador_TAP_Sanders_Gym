...
public class Metodos {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (userSelection == JFileChooser.APPROVE_OPTION) {
                    ...
                    preguntarAbrirPDF(fileToSave.getAbsolutePath());
                    //enviarCorreoConPDFEmpleado(correo_e, fileToSave.getAbsolutePath(), nombre, Contra);
                }
            }
        } catch (SQLException e) {
            System.out.println("Error de base de datos: " + e.getMessage());
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (userSelection == JFileChooser.APPROVE_OPTION) {
                    ...
                    preguntarAbrirPDF(fileToSave.getAbsolutePath());
                    //enviarCorreoConPDFEmpleadoE(correo_e, fileToSave.getAbsolutePath(), nombre, Contra);
                }
            }
        } catch (SQLException e) {
            System.out.println("Error de base de datos: " + e.getMessage());
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (userSelection == JFileChooser.APPROVE_OPTION) {
                    ...
                    preguntarAbrirPDF(fileToSave.getAbsolutePath());
                    //enviarCorreoConPDFAdministrador(correo_a, fileToSave.getAbsolutePath(), nombre, ContraA);
                }
            }
        } catch (SQLException e) {
            System.out.println("Error de base de datos: " + e.getMessage());
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (userSelection == JFileChooser.APPROVE_OPTION) {
                    ...
                    preguntarAbrirPDF(fileToSave.getAbsolutePath());
                    //enviarCorreoConPDFAdministradorE(correo_a, fileToSave.getAbsolutePath(), nombre, ContraA);                    
                }
            }
        } catch (SQLException e) {
            System.out.println("Error de base de datos: " + e.getMessage());
    ...
    String usuario = "sandersgym@gmail.com"; // Cambia esto por tu correo de Gmail
    String clave = "ldti jzex rccw uhtd"; // Cambia esto por tu contraseña de Gmail
    ...
    public void enviarCorreoConPDFEmpleado(String correoDestinoE, String archivoPDF, String nombre, String ContraE) {
    Properties props = new Properties();
    props.put("mail.smtp.auth", "true");
    props.put("mail.smtp.starttls.enable", "true");
    props.put("mail.smtp.host", "smtp.gmail.com");
    ...
    try {
        javax.mail.Message message = new MimeMessage(session);
        message.setFrom(new InternetAddress(usuario));
        message.setRecipients(javax.mail.Message.RecipientType.TO, InternetAddress.parse(correoDestinoE));
        message.setSubject("Registro de Empleado");
        ...
        String htmlContent = String.format(
            ...
            + "        <tr>"
            + "            <td align=\"center\">"
            + "                <h1>¡Gracias por unirte a nuestra familia!</h1>"
            + "                <p><strong>Estimado %s,</strong></p>"
            + "                <p>Te damos la bienvenida a nuestra familia de fitness. Nos complace informarte que has sido registrado exitosamente en nuestro sistema como un empleado.</p>"
            + "                <p>Te mostramos tus datos con los cuales podras logearte.</p>"
            + "                <p><strong>Te mostramos tu correo: %s</strong></p>"
            + "                <p><strong>Te mostramos tu contraseña: %s</strong></p>"
            + "                <p>Esperamos que disfrutes de todos los beneficios que ofrecemos y logres alcanzar tus objetivos de salud y bienestar.</p>"
            + "                <p>¡Gracias por elegirnos!</p>"
            + "                <p>Saludos cordiales,<br>El equipo de %s</p>"
            + "            </td>"
            ...
            + "</body>"
            + "</html>",
            nombre, correoDestinoE, ContraE, "SandersGym"
        );
        ...
        JOptionPane.showMessageDialog(null, "Correo enviado exitosamente a " + correoDestinoE);
    ...
    public void enviarCorreoConPDFEmpleadoE(String correoDestinoE, String archivoPDF, String nombre, String ContraE) {
    Properties props = new Properties();
    props.put("mail.smtp.auth", "true");
    props.put("mail.smtp.starttls.enable", "true");
    props.put("mail.smtp.host", "smtp.gmail.com");
    ...
    try {
        ...
        message.setFrom(new InternetAddress(usuario));
        message.setRecipients(javax.mail.Message.RecipientType.TO, InternetAddress.parse(correoDestinoE));
        message.setSubject("Registro de Edicion De Empleado");
        ...
        String htmlContent = String.format(
            ...
            + "<meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\">"
            + "<meta content=\"telephone=no\" name=\"format-detection\">"
            + "<title>Registro de edición de Empleado</title>"
            + "<style type=\"text/css\">"
            + "body {"
            + "    width: 100%%;"
            + "    font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif;"
    ...
    public void enviarCorreoConPDFAdministrador(String correoDestinoA, String archivoPDF, String nombre, String ContraA) {
    Properties props = new Properties();
    props.put("mail.smtp.auth", "true");
    props.put("mail.smtp.starttls.enable", "true");
    props.put("mail.smtp.host", "smtp.gmail.com");
    ...
    try {
        javax.mail.Message message = new MimeMessage(session);
        message.setFrom(new InternetAddress(usuario));
        message.setRecipients(javax.mail.Message.RecipientType.TO, InternetAddress.parse(correoDestinoA));
        ...
        String htmlContent = String.format(
            ...
            + "                <h1>¡Gracias por unirte a nuestra familia!</h1>"
            + "                <p><strong>Estimado %s,</strong></p>"
            + "                <p>Te damos la bienvenida a nuestra familia de fitness. Nos complace informarte que has sido registrado exitosamente en nuestro sistema como un Administrador.</p>"
            + "                <p>Te mostramos tus datos con los cuales podras logearte.</p>"
            + "                <p><strong>Te mostramos tu correo: %s</strong></p>"
            + "                <p><strong>Te mostramos tu contraseña: %s</strong></p>"
            + "                <p>Esperamos que disfrutes de todos los beneficios que ofrecemos y logres alcanzar tus objetivos de salud y bienestar.</p>"
            ...
            + "</body>"
            + "</html>",
            nombre, correoDestinoA, ContraA, "SandersGym"
        );
        ...
        JOptionPane.showMessageDialog(null, "Correo enviado exitosamente a " + correoDestinoA);
    ...
    public void enviarCorreoConPDFAdministradorE(String correoDestinoA, String archivoPDF, String nombre, String ContraA) {
    Properties props = new Properties();
    props.put("mail.smtp.auth", "true");
    props.put("mail.smtp.starttls.enable", "true");
    props.put("mail.smtp.host", "smtp.gmail.com");
    ...
    try {
        ...
        message.setFrom(new InternetAddress(usuario));
        message.setRecipients(javax.mail.Message.RecipientType.TO, InternetAddress.parse(correoDestinoA));
        message.setSubject("Registro de Edicion De Administrador");
        ...
        String htmlContent = String.format(
            ...
            + "<meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\">"
            + "<meta content=\"telephone=no\" name=\"format-detection\">"
            + "<title>Registro de edición de Administrador</title>"
            + "<style type=\"text/css\">"
            + "body {"
            + "    width: 100%%;"
            + "    font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif;"
            ...
            + "        <tr>"
            + "            <td align=\"center\">"
            + "                <h1>Edición de datos de Administrador</h1>"
            + "                <p><strong>Estimado %s,</strong></p>"
            + "                <p>Por este medio se te notifica que se han actualizado correctamente tus datos en nuestro sistema.</p>"
            + "                <p><strong>Te mostramos tu correo:%s</strong></p>"
            + "                <p><strong>Te mostramos tu contraseña:%s</strong></p>"
